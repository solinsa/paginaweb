...
const post = await client.fetch('*[_type == "post" && slug.current == "plan-mantenimiento-emergencia-laboratorio"]{_id, title, "slug": slug.current, publishedAt, "cat": category->title, excerpt, "mainImage": mainImage.asset->url}[0]');
