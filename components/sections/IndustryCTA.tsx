...
export default function IndustryCTA({ title, description, ctaLabel = 'Cotizar para mi industria', ctaWhatsappText }: IndustryCTAProps) {
  const waLink = `${WA}?text=${encodeURIComponent(ctaWhatsappText || `Quiero cotizar para la industria ${title}`)}`
