...
const products: Product[] = [
  {name:'ChroZen HPLC',brand:'Young In Chromass',description:'Sistema HPLC modular para análisis cuantitativo de rutina.',family:'Cromatografía',techniques:['HPLC'],type:'Equipo',href:'/soluciones/hplc-uhplc'},
  {name:'ChroZen UHPLC',brand:'Young In Chromass',description:'Sistema de alta presión para separaciones rápidas y eficientes.',family:'Cromatografía',techniques:['UHPLC'],type:'Equipo',href:'/soluciones/hplc-uhplc'},
  {name:'ChroZen HPLC preparativo',brand:'Young In Chromass',description:'Purificación a escala preparativa con colector de fracciones.',family:'Cromatografía',techniques:['HPLC'],type:'Equipo',href:'/soluciones/hplc-uhplc'},
  {name:'Detector de índice de refracción RID',brand:'Young In Chromass',description:'Detección para azúcares y compuestos sin absorción UV.',family:'Cromatografía',techniques:['HPLC','UHPLC'],type:'Detector',href:'/soluciones/hplc-uhplc'},
  {name:'Detector ELSD para LC',brand:'Sedere',description:'Detector universal para compuestos no volátiles sin cromóforo.',family:'Cromatografía',techniques:['HPLC','UHPLC'],type:'Detector',href:'/soluciones/hplc-uhplc'},
  {name:'ChroZen GC',brand:'Young In Chromass',description:'Cromatógrafo de gases configurable por aplicación y detector.',family:'Cromatografía',techniques:['GC'],type:'Equipo',href:'/soluciones/gc-gcms'},
  {name:'Sistema GC-MS',brand:'QTEK',description:'Cromatografía de gases con espectrometría de masas.',family:'Cromatografía',techniques:['GC-MS'],type:'Equipo',href:'/soluciones/gc-gcms'},
  {name:'Detector VUV',brand:'VUV Analytics',description:'Detección espectral VUV para análisis cualitativo y cuantitativo.',family:'Espectroscopía',techniques:['GC'],type:'Detector',href:'/soluciones/gc-gcms'},
  {name:'Detector TEA',brand:'Ellutia',description:'Detección selectiva para compuestos de nitrógeno.',family:'Cromatografía',techniques:['GC'],type:'Detector',href:'/soluciones/gc-gcms'},
  {name:'Automuestreador para GC y LC',brand:'HTA',description:'Automatización de inyección para secuencias analíticas.',family:'Cromatografía',techniques:['GC','HPLC'],type:'Accesorio',href:'/soluciones/gc-gcms'},
  {name:'Sistema de purga y trampa',brand:'EST Analytical',description:'Preparación automatizada de muestras para compuestos volátiles.',family:'Preparación de muestras',techniques:['GC-MS'],type:'Equipo',href:'/soluciones/gc-gcms'},
  {name:'Sistema de pirólisis',brand:'CDS Analytical',description:'Preparación térmica de muestras para análisis por GC y GC-MS.',family:'Preparación de muestras',techniques:['GC','GC-MS'],type:'Equipo',href:'/soluciones/gc-gcms'},
  ...
  {name:'Espectrofotómetro UV-Vis',brand:'Persee',description:'Espectroscopía UV-Visible para análisis de rutina.',family:'Espectroscopía',techniques:['UV-Vis'],type:'Equipo',href:'/soluciones'},
  {name:'Espectrómetro de absorción atómica',brand:'Persee',description:'Análisis elemental por absorción atómica.',family:'Espectroscopía',techniques:['AAS'],type:'Equipo',href:'/soluciones'},
  {name:'Sistema de agua ultrapura',brand:'Young In Chromass',description:'Producción de agua para aplicaciones analíticas de laboratorio.',family:'Sistemas de agua',techniques:['Agua Tipo I'],type:'Equipo',href:'/soluciones'},
  {name:'Columnas analíticas HPLC',brand:'Trajan',description:'Columnas y guardas para separaciones cromatográficas.',family:'Consumibles',techniques:['HPLC','UHPLC'],type:'Consumible',href:'/soluciones/consumibles'},
  ...
  {name:'Bibliotecas espectrales MS',brand:'Wiley',description:'Bibliotecas de referencia para identificación espectral.',family:'Software y bibliotecas',techniques:['GC-MS'],type:'Software',href:'/soluciones/consumibles'},
]
