...
const products: Product[] = [
  {name:'ChroZen HPLC',image:'/images/productos/chrozen-hplc.png',brand:'Young In Chromass',description:'Sistema HPLC modular para análisis cuantitativo de rutina.',family:'Cromatografía',techniques:['HPLC'],type:'Equipo',href:'/soluciones/chrozen-hplc'},
  {name:'ChroZen UHPLC',image:'/images/productos/chrozen-uhplc.png',brand:'Young In Chromass',description:'Sistema de alta presión para separaciones rápidas y eficientes.',family:'Cromatografía',techniques:['UHPLC'],type:'Equipo',href:'/soluciones/chrozen-uhplc'},
  {name:'ChroZen HPLC preparativo',image:'/images/productos/chrozen-hplc-preparativo.png',brand:'Young In Chromass',description:'Purificación a escala preparativa con colector de fracciones.',family:'Cromatografía',techniques:['HPLC'],type:'Equipo',href:'/soluciones/chrozen-hplc-preparativo'},
  {name:'Detector de índice de refracción RID',image:'/images/productos/detector-rid.png',brand:'Young In Chromass',description:'Detección para azúcares y compuestos sin absorción UV.',family:'Cromatografía',techniques:['HPLC','UHPLC'],type:'Detector',href:'/soluciones/detector-rid'},
  {name:'Detector ELSD para LC',image:'/images/productos/detector-elsd.png',brand:'Sedere',description:'Detector universal para compuestos no volátiles sin cromóforo.',family:'Cromatografía',techniques:['HPLC','UHPLC'],type:'Detector',href:'/soluciones/detector-elsd'},
  {name:'ChroZen GC',image:'/images/productos/chrozen-gc.png',brand:'Young In Chromass',description:'Cromatógrafo de gases configurable por aplicación y detector.',family:'Cromatografía',techniques:['GC'],type:'Equipo',href:'/soluciones/chrozen-gc'},
  {name:'Sistema GC-MS',image:'/images/productos/gc-ms.png',brand:'QTEK',description:'Cromatografía de gases con espectrometría de masas.',family:'Cromatografía',techniques:['GC-MS'],type:'Equipo',href:'/soluciones/gc-ms'},
  {name:'Detector VUV',image:'/images/productos/detector-vuv.png',brand:'VUV Analytics',description:'Detección espectral VUV para análisis cualitativo y cuantitativo.',family:'Espectroscopía',techniques:['GC'],type:'Detector',href:'/soluciones/detector-vuv'},
  {name:'Detector TEA',image:'/images/productos/detector-tea.png',brand:'Ellutia',description:'Detección selectiva para compuestos de nitrógeno.',family:'Cromatografía',techniques:['GC'],type:'Detector',href:'/soluciones/detector-tea'},
  {name:'Automuestreador para GC y LC',image:'/images/productos/automuestreador-gc-lc.png',brand:'HTA',description:'Automatización de inyección para secuencias analíticas.',family:'Cromatografía',techniques:['GC','HPLC'],type:'Accesorio',href:'/soluciones/automuestreador-hta'},
  {name:'Sistema de purga y trampa',image:'/images/productos/purga-trampa.png',brand:'EST Analytical',description:'Preparación automatizada de muestras para compuestos volátiles.',family:'Preparación de muestras',techniques:['GC-MS'],type:'Equipo',href:'/soluciones/purga-trampa'},
  {name:'Sistema de pirólisis',image:'/images/productos/pirolisis.png',brand:'CDS Analytical',description:'Preparación térmica de muestras para análisis por GC y GC-MS.',family:'Preparación de muestras',techniques:['GC','GC-MS'],type:'Equipo',href:'/soluciones/pirolisis'},
  {name:'Cromatógrafo iónico',image:'/images/productos/cromatografo-ionico.png',brand:'Shine',description:'Análisis de aniones y cationes con opciones de supresión.',family:'Cromatografía',techniques:['IC'],type:'Equipo',href:'/soluciones/ic'},
  {name:'Espectrofotómetro UV-Vis',image:'/images/productos/espectrofotometro-uv-vis.png?v=2',brand:'Persee',description:'Espectroscopía UV-Visible para análisis de rutina.',family:'Espectroscopía',techniques:['UV-Vis'],type:'Equipo',href:'/soluciones/espectrofotometro-uv-vis'},
  {name:'Espectrómetro de absorción atómica',image:'/images/productos/espectrometro-aas.png',brand:'Persee',description:'Análisis elemental por absorción atómica.',family:'Espectroscopía',techniques:['AAS'],type:'Equipo',href:'/soluciones/espectrometro-aas'},
