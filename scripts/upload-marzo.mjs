/**
 * upload-marzo.mjs — Sube imágenes, crea y publica los 10 posts de marzo 2026.
 *
 * Uso: node scripts/upload-marzo.mjs
 */
...
const POSTS = [
  { file: '01-estabilidad-farmacos',       slug: 'estabilidad-farmacos-hplc-usp-ich',         publishedAt: '2026-03-02T06:00:00Z' },
  { file: '02-cov-atmosfericos-ftir',       slug: 'cov-atmosfericos-ftir-monitoreo',           publishedAt: '2026-03-05T06:00:00Z' },
  { file: '03-acrilamida-alimentos',        slug: 'acrilamida-furanos-alimentos-gcmsms',       publishedAt: '2026-03-08T06:00:00Z' },
  { file: '04-cannabinoides-lcmsms',        slug: 'cannabinoides-terpenos-lcmsms',             publishedAt: '2026-03-11T06:00:00Z' },
  { file: '05-validacion-cromatografia-ionica', slug: 'validacion-cromatografia-ionica',       publishedAt: '2026-03-14T06:00:00Z' },
  { file: '06-lims-automatizacion',         slug: 'lims-automatizacion-laboratorios-2026',     publishedAt: '2026-03-17T06:00:00Z' },
  { file: '07-congeneres-tequila-gc',       slug: 'congeneres-perfil-aroma-tequila-gc',        publishedAt: '2026-03-20T06:00:00Z' },
  { file: '08-btex-petroquimica',           slug: 'btex-suelos-aguas-petroquimica-gcms',       publishedAt: '2026-03-23T06:00:00Z' },
  { file: '09-spc-control-estadistico',     slug: 'spc-cartas-control-laboratorio-analitico',  publishedAt: '2026-03-26T06:00:00Z' },
  { file: '10-solinsa-primavera',           slug: 'solinsa-primavera-2026-novedades',          publishedAt: '2026-03-29T06:00:00Z' },
];
...
async function main() {
  ...
  for (const post of POSTS) {
    ...
    // 4. Create post — clean slug, never numeric-prefixed
  ...
  console.log(`\n🎉 COMPLETADO: ${created.length} posts de marzo 2026 publicados.`);
}
