/**
 * upload-noviembre.mjs — Sube imágenes, crea y publica los 10 posts de noviembre 2025.
 *
 * Uso: node scripts/upload-noviembre.mjs
 */
...
const POSTS = [
  { file: '01-icp-ms-agua-potable',       publishedAt: '2025-11-03T06:00:00Z' },
  { file: '02-lcms-bioequivalencia',       publishedAt: '2025-11-06T06:00:00Z' },
  { file: '03-validacion-limpieza-hplc',   publishedAt: '2025-11-10T06:00:00Z' },
  { file: '04-ftir-polimeros-recubrimientos', publishedAt: '2025-11-13T06:00:00Z' },
  { file: '05-mantenimiento-preventivo-hplc', publishedAt: '2025-11-17T06:00:00Z' },
  { file: '06-metales-pesados-aguas-icp-oes', publishedAt: '2025-11-20T06:00:00Z' },
  { file: '07-plaguicidas-gcms-ms-frutas',   publishedAt: '2025-11-24T06:00:00Z' },
  { file: '08-tph-suelos-gc-fid',            publishedAt: '2025-11-27T06:00:00Z' },
  { file: '09-capacitacion-cromatografia',   publishedAt: '2025-11-28T06:00:00Z' },
  { file: '10-control-calidad-gc-industria-quimica', publishedAt: '2025-11-29T06:00:00Z' },
];
...
async function main() {
  ...
  for (const post of POSTS) {
    ...
    // 1. Upload image
    const imgPath = resolve(BASE, 'public', 'noviembre', `${post.file}.png`);
    ...
    const bodyPath = resolve(BASE, 'bodies', 'noviembre', `${post.file}.md`);
    ...
    // 3. Get excerpt from frontmatter or generate short one
    ...
    const slug = frontmatter.slug || post.file;
  ...
  console.log(`\n🎉 COMPLETADO: ${created.length} posts de noviembre 2025 publicados.`);
}
