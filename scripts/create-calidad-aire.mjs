/**
 * Crea el post de 5 Métodos Clave para el Análisis de Calidad del Aire por Cromatografía de Gases.
...
async function main() {
  // 1. Subir imagen
  const imagePath = resolve(import.meta.dirname, '..', 'public/abril/05-calidad-aire-gc.png');
  console.log(`📤 Subiendo imagen: ${imagePath}`);
  const asset = await client.assets.upload('image', createReadStream(imagePath), {
    contentType: 'image/png',
    filename: '05-calidad-aire-gc.png',
  });
  console.log(`✅ Imagen subida: ${asset._id}`);

  // 2. Leer y convertir body
  const bodyMd = readFileSync('/Users/samuelnavarro/Desktop/body-calidad-aire-gc.md', 'utf-8');
  ...
  const doc = {
    _type: 'post',
    title: '5 Métodos Clave para el Análisis de Calidad del Aire por Cromatografía de Gases',
    slug: { _type: 'slug', current: '5-metodos-clave-analisis-calidad-aire-cromatografia-gases' },
    ...
    excerpt: 'Los 5 métodos esenciales para análisis de calidad del aire por GC: TO-15/TO-17 para VOCs, TO-14 BTEX, compuestos de azufre, gases efecto invernadero y semivolátiles. Configuración y detectores.',
    body,
    publishedAt: '2026-04-13T06:00:00Z',
  };
