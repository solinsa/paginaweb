/**
 * Crea el post '5 Estrategias para Optimizar el Rendimiento de tu HPLC en el Laboratorio'.
...
async function main() {
  // 1. Subir imagen
  const imagePath = resolve(import.meta.dirname, '..', 'public/abril/09-optimizar-hplc.png');
  console.log(`📤 Subiendo imagen: ${imagePath}`);
  const asset = await client.assets.upload('image', createReadStream(imagePath), {
    contentType: 'image/png',
    filename: '09-optimizar-hplc.png',
  });
  console.log(`✅ Imagen subida: ${asset._id}`);

  // 2. Leer y convertir body
  const bodyMd = readFileSync('/Users/samuelnavarro/Desktop/body-optimizar-hplc.md', 'utf-8');
  ...
  const doc = {
    _type: 'post',
    title: '5 Estrategias para Optimizar el Rendimiento de tu HPLC en el Laboratorio',
    slug: { _type: 'slug', current: '5-estrategias-optimizar-rendimiento-hplc-laboratorio' },
    author: 'Equipo Solinsa',
    mainImage: { _type: 'image', asset: { _type: 'reference', _ref: asset._id } },
    category: { _type: 'reference', _ref: 'cat-prod-lab' },
    excerpt: '5 estrategias prácticas para optimizar el rendimiento de tu HPLC: mantenimiento de columna, optimización de fase móvil, reducción de tiempos de corrida, automuestreador eficiente y calibración periódica.',
    body,
    publishedAt: '2026-04-25T06:00:00Z',
  };
