/**
 * upload-diciembre.mjs — Sube imágenes, crea y publica los 10 posts de diciembre 2025.
 *
 * Uso: node scripts/upload-diciembre.mjs
 */
...
const POSTS = [
  { file: '01-conservadores-cosmeticos-hplc',       publishedAt: '2025-12-03T06:00:00Z' },
  { file: '02-baseline-hplc-gc',                     publishedAt: '2025-12-06T06:00:00Z' },
  { file: '03-validacion-metodos-cualitativos-gcms', publishedAt: '2025-12-09T06:00:00Z' },
  { file: '04-acidos-organicos-vinos-cervezas',      publishedAt: '2025-12-12T06:00:00Z' },
  { file: '05-pesticidas-agua-gcms-epa',             publishedAt: '2025-12-15T06:00:00Z' },
  { file: '06-acidos-nucleicos-lcms',                publishedAt: '2025-12-18T06:00:00Z' },
  { file: '07-mantenimiento-interno-vs-externo',     publishedAt: '2025-12-21T06:00:00Z' },
  { file: '08-fenoles-aceite-oliva-hplc',            publishedAt: '2025-12-24T06:00:00Z' },
  { file: '09-cloro-ozono-agua',                     publishedAt: '2025-12-27T06:00:00Z' },
  { file: '10-resumen-2025-tendencias-2026',         publishedAt: '2025-12-30T06:00:00Z' },
];
...
async function main() {
  ...
  console.log(`\n🎉 COMPLETADO: ${created.length} posts de diciembre 2025 publicados.`);
}
